...
class LevelEight extends Phaser.Scene {
	...
	editorCreate() {
		...
		// rectangle
		const rectangle = this.add.rectangle(790, 865, 500, 10);
		...
		// rectangle_1
		const rectangle_1 = this.add.rectangle(1090, 765, 100, 10);
		...
		// rectangle_3
		const rectangle_3 = this.add.rectangle(1045, 810, 10, 100);
		rectangle_3.visible = false;
		rectangle_3.isFilled = true;
		colliderContainer.add(rectangle_3);

		// rectangle_4
		const rectangle_4 = this.add.rectangle(1235, 755, 10, 200);
		...
		// rectangle_18
		const rectangle_18 = this.add.rectangle(1145, 710, 10, 100);
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelEightTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelEightTimer;
