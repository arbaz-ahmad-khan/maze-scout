...
class LevelSix extends Phaser.Scene {
	...
	editorCreate() {
		...
		// boxTile_7
		const boxTile_7 = this.add.image(690, 810, "box-tile");
		boxTileContainer.add(boxTile_7);

		// boxTile_9
		const boxTile_9 = this.add.image(590, 810, "box-tile");
		boxTileContainer.add(boxTile_9);

		// boxTile_10
		const boxTile_10 = this.add.image(590, 710, "box-tile");
		boxTileContainer.add(boxTile_10);

		// boxTile_17
		const boxTile_17 = this.add.image(790, 810, "box-tile");
		boxTileContainer.add(boxTile_17);

		// boxTile_18
		const boxTile_18 = this.add.image(890, 810, "box-tile");
		boxTileContainer.add(boxTile_18);

		// boxTile_19
		const boxTile_19 = this.add.image(990, 810, "box-tile");
		boxTileContainer.add(boxTile_19);

		// boxTile_28
		const boxTile_28 = this.add.image(1090, 810, "box-tile");
		boxTileContainer.add(boxTile_28);

		// boxTile_29
		const boxTile_29 = this.add.image(1190, 810, "box-tile");
		boxTileContainer.add(boxTile_29);

		// boxTile_30
		const boxTile_30 = this.add.image(1290, 810, "box-tile");
		boxTileContainer.add(boxTile_30);

		// boxTile_31
		const boxTile_31 = this.add.image(590, 610, "box-tile");
		boxTileContainer.add(boxTile_31);

		// boxTile_32
		const boxTile_32 = this.add.image(590, 510, "box-tile");
		boxTileContainer.add(boxTile_32);

		// boxTile_33
		const boxTile_33 = this.add.image(590, 410, "box-tile");
		boxTileContainer.add(boxTile_33);

		// boxTile_34
		const boxTile_34 = this.add.image(590, 310, "box-tile");
		boxTileContainer.add(boxTile_34);

		// boxTile_35
		const boxTile_35 = this.add.image(690, 310, "box-tile");
		boxTileContainer.add(boxTile_35);

		// boxTile_36
		const boxTile_36 = this.add.image(690, 410, "box-tile");
		boxTileContainer.add(boxTile_36);

		// boxTile_37
		const boxTile_37 = this.add.image(790, 410, "box-tile");
		boxTileContainer.add(boxTile_37);

		// boxTile_38
		const boxTile_38 = this.add.image(790, 510, "box-tile");
		boxTileContainer.add(boxTile_38);

		// boxTile_39
		const boxTile_39 = this.add.image(790, 610, "box-tile");
		boxTileContainer.add(boxTile_39);

		// boxTile_40
		const boxTile_40 = this.add.image(790, 710, "box-tile");
		boxTileContainer.add(boxTile_40);

		// boxTile_41
		const boxTile_41 = this.add.image(1290, 710, "box-tile");
		boxTileContainer.add(boxTile_41);

		// boxTile_42
		const boxTile_42 = this.add.image(1290, 610, "box-tile");
		boxTileContainer.add(boxTile_42);

		// boxTile_43
		const boxTile_43 = this.add.image(1290, 510, "box-tile");
		boxTileContainer.add(boxTile_43);

		// boxTile_44
		const boxTile_44 = this.add.image(1290, 410, "box-tile");
		boxTileContainer.add(boxTile_44);

		// boxTile_45
		const boxTile_45 = this.add.image(1290, 310, "box-tile");
		boxTileContainer.add(boxTile_45);

		// boxTile_46
		const boxTile_46 = this.add.image(1190, 310, "box-tile");
		boxTileContainer.add(boxTile_46);

		// boxTile_47
		const boxTile_47 = this.add.image(1190, 410, "box-tile");
		boxTileContainer.add(boxTile_47);

		// boxTile_48
		const boxTile_48 = this.add.image(1090, 410, "box-tile");
		boxTileContainer.add(boxTile_48);

		// boxTile_49
		const boxTile_49 = this.add.image(1090, 510, "box-tile");
		boxTileContainer.add(boxTile_49);

		// boxTile_50
		const boxTile_50 = this.add.image(1090, 610, "box-tile");
		boxTileContainer.add(boxTile_50);

		// boxTile_51
		const boxTile_51 = this.add.image(1090, 710, "box-tile");
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelSixTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelSixTimer;
