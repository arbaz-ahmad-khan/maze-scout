...
class LevelTen extends Phaser.Scene {
	...
	editorCreate() {
		...
		// boxTile_9
		const boxTile_9 = this.add.image(890, 710, "box-tile");
		boxTileContainer.add(boxTile_9);

		// boxTile_10
		const boxTile_10 = this.add.image(990, 710, "box-tile");
		boxTileContainer.add(boxTile_10);

		// boxTile_11
		const boxTile_11 = this.add.image(1090, 710, "box-tile");
		boxTileContainer.add(boxTile_11);

		// boxTile_12
		const boxTile_12 = this.add.image(1190, 710, "box-tile");
		boxTileContainer.add(boxTile_12);

		// boxTile_13
		const boxTile_13 = this.add.image(690, 610, "box-tile");
		boxTileContainer.add(boxTile_13);

		// boxTile_19
		const boxTile_19 = this.add.image(690, 510, "box-tile");
		boxTileContainer.add(boxTile_19);

		// boxTile_20
		const boxTile_20 = this.add.image(790, 510, "box-tile");
		boxTileContainer.add(boxTile_20);

		// boxTile_22
		const boxTile_22 = this.add.image(890, 510, "box-tile");
		boxTileContainer.add(boxTile_22);

		// boxTile_26
		const boxTile_26 = this.add.image(990, 510, "box-tile");
		boxTileContainer.add(boxTile_26);

		// boxTile_27
		const boxTile_27 = this.add.image(1090, 510, "box-tile");
		boxTileContainer.add(boxTile_27);

		// boxTile_28
		const boxTile_28 = this.add.image(1190, 510, "box-tile");
		...
		// boxTile_5
		const boxTile_5 = this.add.image(1190, 310, "box-tile");
		boxTileContainer.add(boxTile_5);

		// boxTile_14
		const boxTile_14 = this.add.image(1090, 310, "box-tile");
		boxTileContainer.add(boxTile_14);

		// boxTile_15
		const boxTile_15 = this.add.image(990, 310, "box-tile");
		boxTileContainer.add(boxTile_15);

		// boxTile_16
		const boxTile_16 = this.add.image(890, 310, "box-tile");
		...
		// rightEye
		const rightEye = this.add.image(114, 466, "character-eyeball");

		// leftEye
		const leftEye = this.add.image(82, 466, "character-eyeball");
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelTenTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelTenTimer;
