...
class LevelTwo extends Phaser.Scene {
	...
	editorCreate() {
		...
		// boxTile_28
		const boxTile_28 = this.add.image(590, 810, "box-tile");
		boxTileContainer.add(boxTile_28);

		// boxTile_29
		const boxTile_29 = this.add.image(1290, 810, "box-tile");
		...
		// boxTile_31
		const boxTile_31 = this.add.image(1290, 610, "box-tile");
		boxTileContainer.add(boxTile_31);

		// boxTile_32
		const boxTile_32 = this.add.image(1290, 710, "box-tile");
		boxTileContainer.add(boxTile_32);

		// boxTile_33
		const boxTile_33 = this.add.image(1290, 310, "box-tile");
		boxTileContainer.add(boxTile_33);

		// boxTile_34
		const boxTile_34 = this.add.image(1290, 510, "box-tile");
		boxTileContainer.add(boxTile_34);

		// boxTile_35
		const boxTile_35 = this.add.image(590, 710, "box-tile");
		...
		// boxTile_42
		const boxTile_42 = this.add.image(890, 310, "box-tile");
		boxTileContainer.add(boxTile_42);

		// boxTile_43
		const boxTile_43 = this.add.image(890, 410, "box-tile");
		boxTileContainer.add(boxTile_43);

		// boxTile_44
		const boxTile_44 = this.add.image(890, 510, "box-tile");
		boxTileContainer.add(boxTile_44);

		// boxTile_45
		const boxTile_45 = this.add.image(890, 610, "box-tile");
		boxTileContainer.add(boxTile_45);

		// boxTile_46
		const boxTile_46 = this.add.image(990, 610, "box-tile");
		boxTileContainer.add(boxTile_46);

		// boxTile_47
		const boxTile_47 = this.add.image(1090, 610, "box-tile");
		boxTileContainer.add(boxTile_47);

		// boxTile_48
		const boxTile_48 = this.add.image(1190, 610, "box-tile");
		...
		// rightEye
		const rightEye = this.add.image(613, 786, "character-eyeball");

		// leftEye
		const leftEye = this.add.image(571, 792, "character-eyeball");
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelTwoTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelTwoTimer;
