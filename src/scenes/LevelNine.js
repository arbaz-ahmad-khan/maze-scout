...
class LevelNine extends Phaser.Scene {
	...
	editorCreate() {
		...
		// boxTile_15
		const boxTile_15 = this.add.image(690, 810, "box-tile");
		boxTileContainer.add(boxTile_15);

		// boxTile_16
		const boxTile_16 = this.add.image(590, 810, "box-tile");
		...
		// boxTile_20
		const boxTile_20 = this.add.image(1090, 810, "box-tile");
		boxTileContainer.add(boxTile_20);

		// boxTile_22
		const boxTile_22 = this.add.image(1290, 810, "box-tile");
		boxTileContainer.add(boxTile_22);

		// boxTile_26
		const boxTile_26 = this.add.image(790, 310, "box-tile");
		boxTileContainer.add(boxTile_26);

		// boxTile_27
		const boxTile_27 = this.add.image(690, 310, "box-tile");
		boxTileContainer.add(boxTile_27);

		// boxTile_28
		const boxTile_28 = this.add.image(890, 310, "box-tile");
		boxTileContainer.add(boxTile_28);

		// boxTile_30
		const boxTile_30 = this.add.image(1290, 410, "box-tile");
		boxTileContainer.add(boxTile_30);

		// boxTile_31
		const boxTile_31 = this.add.image(1290, 510, "box-tile");
		boxTileContainer.add(boxTile_31);

		// boxTile_32
		const boxTile_32 = this.add.image(1290, 610, "box-tile");
		boxTileContainer.add(boxTile_32);

		// boxTile_33
		const boxTile_33 = this.add.image(1290, 710, "box-tile");
		boxTileContainer.add(boxTile_33);

		// boxTile_34
		const boxTile_34 = this.add.image(1290, 310, "box-tile");
		boxTileContainer.add(boxTile_34);

		// boxTile_35
		const boxTile_35 = this.add.image(1190, 310, "box-tile");
		boxTileContainer.add(boxTile_35);

		// boxTile_36
		const boxTile_36 = this.add.image(1190, 810, "box-tile");
		boxTileContainer.add(boxTile_36);

		// boxTile_37
		const boxTile_37 = this.add.image(590, 610, "box-tile");
		boxTileContainer.add(boxTile_37);

		// boxTile_38
		const boxTile_38 = this.add.image(690, 410, "box-tile");
		boxTileContainer.add(boxTile_38);

		// boxTile_39
		const boxTile_39 = this.add.image(990, 310, "box-tile");
		boxTileContainer.add(boxTile_39);

		// boxTile_40
		const boxTile_40 = this.add.image(1090, 310, "box-tile");
		boxTileContainer.add(boxTile_40);

		// boxTile_41
		const boxTile_41 = this.add.image(690, 610, "box-tile");
		boxTileContainer.add(boxTile_41);

		// boxTile_42
		const boxTile_42 = this.add.image(790, 610, "box-tile");
		boxTileContainer.add(boxTile_42);

		// boxTile_43
		const boxTile_43 = this.add.image(890, 610, "box-tile");
		boxTileContainer.add(boxTile_43);

		// boxTile_44
		const boxTile_44 = this.add.image(990, 610, "box-tile");
		boxTileContainer.add(boxTile_44);

		// boxTile_45
		const boxTile_45 = this.add.image(990, 510, "box-tile");
		boxTileContainer.add(boxTile_45);

		// boxTile_46
		const boxTile_46 = this.add.image(990, 410, "box-tile");
		boxTileContainer.add(boxTile_46);

		// boxTile_47
		const boxTile_47 = this.add.image(590, 410, "box-tile");
		boxTileContainer.add(boxTile_47);

		// boxTile_48
		const boxTile_48 = this.add.image(790, 410, "box-tile");
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelNineTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelNineTimer;
