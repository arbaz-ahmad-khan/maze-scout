...
class LevelFourteen extends Phaser.Scene {
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelFourteenTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelFourteenTimer;
