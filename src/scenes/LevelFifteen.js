...
class LevelFifteen extends Phaser.Scene {
	...
	editorCreate() {
		...
		// boxTile_23
		const boxTile_23 = this.add.image(1345, 610, "box-tile");
		...
		// boxTile_34
		const boxTile_34 = this.add.image(1345, 510, "box-tile");
		...
		// character
		const character = this.add.image(445, 610, "character-without-eyes");

		// rightEye
		const rightEye = this.add.image(445, 610, "character-eyeball");

		// leftEye
		const leftEye = this.add.image(445, 610, "character-eyeball");
	...
	create() {
		...
		let tempEndTime = Date.now() + this.oGameManager.levelFifteenTimer;
	...
	startLevelTimer() {
		if(!this.isTimerRunning && this.isTimerStarted) {
			this.endTime = Date.now() + this.oGameManager.levelFifteenTimer;
